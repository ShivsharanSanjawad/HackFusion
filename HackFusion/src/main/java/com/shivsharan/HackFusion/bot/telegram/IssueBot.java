...
public class IssueBot extends AbilityBot {
    ...
    public IssueBot(Environment env,
                    ...
                    OperatorsService operatorsService, MLpipeline mLpipeline,
        ...
        this.responseHandler = new ResponseHandler(silent, db, this, departmentService,
                reportService, operatorsService, mLpipeline, cloudinaryService);
    }
